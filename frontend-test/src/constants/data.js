...
export const WHY_POINTS = [
  ...
  { icon:"⚖️", title:"Zero Bias Guaranteed",    desc:"Demographic data is redacted before any scoring. Candidates win on merit — nothing else." },
  { icon:"🎙️", title:"Real Voice Interviews",   desc:"Vapi-powered AI conducts natural voice interviews, generating unique questions from each resume." },
  ...
  { icon:"🗓️", title:"Auto-Calendar Sync",       desc:"Winners are scheduled directly into Google or Outlook. Zero manual coordination." },
];
...
export const HOW_IT_WORKS_STEPS = [
  ...
  { num:"05", title:"Voice Interview Conducted",    desc:"Vapi dials in. The AI asks adaptive, resume-specific questions. Anti-cheat monitors in real time.", icon:"🎙️" },
